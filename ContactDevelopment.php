...
<div id="sequence106" class="sequence-slider" style="padding-bottom:60%">
...
<style>
#header-wrapper{
    background: url(images/contact_dev.jpg);
    background-repeat: no-repeat;
    background-size: cover;
}
@media (max-width: 1700px){
#header-wrapper{
background: url(images/slider/med/contact_dev.jpg); 
background-repeat: no-repeat;
background-size: cover;
}}
@media (max-width: 700px){
#header-wrapper{
background: url(images/slider/small/contact_dev.jpg); 
background-repeat: no-repeat;
background-size: cover;
}}
    ...
    <div id="rmvcon" class="container" >
            ...
            <div class="panel panel-default well" style="background-color: transparent;border-color: transparent;">
                <div class="panel-body" >
                    ...
                    <p class="lead scrolltop"><?php echo $_SESSION['cdev_' . $x];  ?></p> <br> 
