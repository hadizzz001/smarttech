...
<style>
#header-wrapper{
    background: url(images/contact_support.jpg);
    background-repeat: no-repeat;
    background-size: cover;
}
@media (max-width: 1700px){
#header-wrapper{
background: url(images/slider/med/contact_support.jpg); 
background-repeat: no-repeat;
background-size: cover;
}}
@media (max-width: 700px){
#header-wrapper{
background: url(images/slider/small/contact_support.jpg); 
background-repeat: no-repeat;
background-size: cover;
}}
    ...
    <div id="rmvcon" class="container" >
            ...
            <div class="panel panel-default well" style="background-color: transparent;border-color: transparent;">
                <div class="panel-body" >
                    ...
                    <p class="lead scrolltop"><?php echo $_SESSION['cspt_' . $x];  ?></p> <br> 
